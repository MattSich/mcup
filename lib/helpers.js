...
exports.initJson = function(cwd) {
  // Build JSON
  console.log("Configuring mcup.json settings file...".cyan);

  var PATH_TO_MPLZ_SETTINGS_JSON = path.resolve(cwd, 'mcup.json');
  var mplzJson = {};
  ...
  prompt.get({properties: {
    ...
    if (err) {
      ...
      jsonFile.writeFile(PATH_TO_MPLZ_SETTINGS_JSON, mplzJson, function (err) {
        ...
        console.log("You can now use mcup setup && deploy!".blue);
      });
    }
  });
};
